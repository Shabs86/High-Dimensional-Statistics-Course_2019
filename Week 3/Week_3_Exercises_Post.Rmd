...
# Dataset
HDS_ex3 <- read.csv("~/Dropbox/Important_Documents/Doctoral_Work/Courses/High Dimensional Stats/2019/Week 3/HDS_ex3.txt", sep=" ")
...
# Get log-lk values from AIC = 2k - 2loglk
# Here 
loglk_aic_full <- (-AIC(lm.fit) + 2*15)/2
loglk_aic_reduced <- (-AIC(lm.fit1) + 2*14)/2
...
# BIC based LRT gets a highly significant p-value as Deviance is very, very hugh compared to critical value of chi.square distribution at 1 degrees of freedom. 
...
tr.ind <- fread("~/Dropbox/Important_Documents/Doctoral_Work/Courses/High Dimensional Stats/2019/Week 3/HDS_ex3.3_tr.txt", sep=" ")
...
# Dataset
library(data.table)
HDS_ex3 <- fread("~/Dropbox/Important_Documents/Doctoral_Work/Courses/High Dimensional Stats/2019/Week 3/HDS_ex3.txt", sep=" ")
