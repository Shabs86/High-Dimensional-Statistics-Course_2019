...
does when it is applied to $\tilde{\pmb{P}}_j$. Crucial property for this proof is
that $\tilde{k}_j$ only depends on $(P_i)_{i\neq j}$ but not on $P_j$, that,
...
which proves the inequality (2) also in this case.
